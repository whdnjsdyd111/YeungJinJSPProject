			...
			<ul class="navbar-nav ml-md-auto">
				<li class="nav-item dropdown"><a
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item" href="mainBoard.do?kind=600&sort=recent">공지사항</a> <a
								class="dropdown-item" href="mainBoard.do?kind=700&sort=recent">소식</a>
						</div></li>
				<li class="nav-item dropdown"><a
						class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
						role="button" data-toggle="dropdown" aria-haspopup="true"
				...
				<li class="nav-item mr-3"><a class="nav-link"
					href="#"><span><i class="fa fa-sign-in mr-2"></i>로그인</span></a></li>
				<li class="nav-item mr-3"><a class="nav-link"
					href="#"><span><i class="fa fa-key mr-2"></i>비밀번호 찾기</span></a></li>
				<li class="nav-item mr-3"><a class="nav-link"
					href="#"><span><i class="fa fa-user-secret mr-2"></i>회원가입</span></a></li>
			</ul>
		</div>
	</div>
</header>
